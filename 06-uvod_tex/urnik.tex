...
Programa za izdelavo \emph{nekakovostnega} urnika načeloma ni težko narediti. Potrebujemo
...
ko so stroge omejitve po pomembnosti \emph{skoraj} enakovredne, se šibke omejitve med seboj
...
\emph{skoraj} vedno ">odločil<", da jih ne bo prekršil. Tak način uteževanja pride v poštev
